...
-- INCREASE LINESIZE AND PAGESIZE

SET LINESIZE 300
SET PAGESIZE 66

-- SELECT ALL COLUMNS FROM VEHICLES_CI
...
-- SELECT ALL COLUMNS FROM BILL_TOS_CI
...
-- SELECT ALL COLUMNS FROM ITEMS_CI
...
-- SELECT ALL COLUMNS FROM OWNERS_CI
...
-- SELECT ALL COLUMNS FROM INVOICES_CI
...
-- SELECT ALL COLUMNS FROM ITEMS_SOLD_CI_CI
...
-- SORT INVOICES_CI BY INVOICE_DATE IN ASCENDING ORDER
...
-- SORT ITEMS_SOLD_CI BY ITEM_QTY_SOLD IN DESCENDING ORDER
...
-- SORT BILL_TOS_CI BY CITY THEN LAST_NAME IN ASCENDING ORDER
...
-- INVOICES BY INVOICE_NO THEN ITEM_UNIT_PRICE
...
-- SELECT ALL ITEMS WITH "FILTER" IN NAME
...
-- SELECT ITEMS SOLD 2 TIMES OR LESS GREATER THAN $20
...
-- SELECT ALL ITEMS IN $25-$199 RANGE
...
-- INNER JOIN OF BILL_TOS_CI AND OWNERS_CI
...
-- OUTER JOIN OF ITEMS_CI AND ITEMS_SOLD_CI
...
-- INNER JOIN OF BILL_TOS_CI, VEHICLES_CI, INVOICES_CI, AND ITEMS_SOLD_CI
...
-- SUBTRACT SOLD ITEMS FROM TOTAL ITEMS
